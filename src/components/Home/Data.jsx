...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">M Raffa
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">I'm data analyst entushianst based in Indonesia , and I'm very passionate and decicated to my work.</p>
